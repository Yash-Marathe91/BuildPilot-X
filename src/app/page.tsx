        ...
        <section id="about" className="py-24 relative z-10 border-t border-white/5">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <p className="text-lg text-white/70 leading-relaxed font-light mb-8">
              BuildPilot X was developed by <strong className="text-white">Krishna Rajput</strong> & <strong className="text-white">Yash Marathe</strong> specifically for the <strong className="text-white">AMD Pervasive AI Developer Contest</strong>. Our mission is to bridge the gap between visionary ideas and functional realities by deploying a team of autonomous, specialized AI executives. Powered by the incredible compute capabilities of AMD GPUs, a high-performance Python FastAPI backend, Next.js, and Supabase, we empower founders to operate with the capacity of a fully-funded venture studio. 
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="glass-card px-6 py-3 rounded-full text-white/80 text-sm font-medium border border-white/10 bg-white/5">Krishna Rajput & Yash Marathe</div>
