      ...
      <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-background/30 backdrop-blur-xl supports-[backdrop-filter]:bg-background/10 transition-all duration-300">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" asChild className="hidden md:flex text-white/60 hover:text-white transition-colors duration-300">
              <Link href="/login">Login</Link>
            </Button>
            <Button asChild className="rounded-full bg-gradient-primary border-none text-white hover:brightness-110 shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-all duration-300">
        ...
        <section className="relative pt-24 pb-20 md:pt-40 md:pb-24">
          <div className="container mx-auto px-4 relative z-10 text-center flex flex-col items-center">
            ...
            <div className="hero-buttons flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Button asChild size="lg" className="rounded-full h-14 px-10 bg-gradient-primary border-none text-white shadow-[0_0_40px_rgba(168,85,247,0.4)] hover:shadow-[0_0_60px_rgba(168,85,247,0.6)] hover:-translate-y-1 transition-all duration-300 font-semibold text-base w-full sm:w-auto group">
                <Link href="/register">Start Building</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-full h-14 px-10 border-white/10 bg-black/50 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 font-semibold text-white text-base w-full sm:w-auto backdrop-blur-md group">
                <Link href="https://github.com/Yash-Marathe91/BuildPilot-X" target="_blank" rel="noopener noreferrer">
